function array_out = displayPTMarginalSymplecticEigenvalues(array_input)
...
for i = 1:modes
    for j = i+1:modes
        ...
        disp(MSG);
        subarr_PT_Eig = eig(1.i*S*L1*submat*transpose(L1));
        subarr_PT_Eig = eig(1.i*S*L2*submat*transpose(L2));
